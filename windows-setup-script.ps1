...
$winget_apps = @("7zip.7zip", "Alacritty.Alacritty", "OrangeDrangon.AndroidMessages.Desktop", "angryziber.AngryIPScanner", "AutoHotkey.AutoHotkey", "BleachBit.BleachBit", "Brave.Brave", "SaeraSoft.CaesiumImageCompressor", "Discord.Discord", "File-New-Project.EarTrumpet", "Epilogue.EpilogueOperator", "yang991178.fluent-reader", "Git.Git", "GitHub.GitHubDesktop", "Google.Drive", "HexChat.HexChat", "JRSoftware.InnoSetup", "GuinpinSoft.MakeMKV", "JeffreyPfau.mGBA", "zyedidia.micro", "Microsoft.DirectX", "Microsoft.VCRedist.2015+.x64", "Microsoft.VCRedist.2015+.x86", "mRemoteNG.mRemoteNG", "OpenJS.NodeJS", "OBSProject.OBSStudio", "Microsoft.PowerShell", "PuTTY.PuTTY", "Python.Python.3.11", "RevoUninstaller.RevoUninstaller", "Front.scrcpy+", "NickeManarin.ScreenToGif", "Starship.Starship", "Valve.Steam", "Mozilla.Thunderbird", "ventoy.Ventoy", "VideoLAN.VLC", "VMware.HorizonClient", "Microsoft.VisualStudioCode", "WinSCP.WinSCP", "Zoom.Zoom")
