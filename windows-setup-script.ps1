...
$winget_apps = @("7zip.7zip", "Alacritty.Alacritty", "Amazon.Games", "angryziber.AngryIPScanner", "BleachBit.BleachBit", "BlenderFoundation.Blender", "SaeraSoft.CaesiumImageCompressor", "Discord.Discord", "ElectronicArts.EADesktop", "File-New-Project.EarTrumpet", "Elgato.4KCaptureUtility", "EpicGames.EpicGamesLauncher", "Epilogue.EpilogueOperator", "GIMP.GIMP", "Git.Git", "GitHub.GitHubDesktop", "Google.Drive", "Inkscape.Inkscape", "KDE.Kdenlive", "GuinpinSoft.MakeMKV", "JeffreyPfau.mGBA", "Microsoft.DotNet.SDK.7", "Microsoft.DirectX", "Microsoft.VCRedist.2015+.x64", "Microsoft.VCRedist.2015+.x86", "Mozilla.Firefox", "mRemoteNG.mRemoteNG", "Guru3D.Afterburner", "OpenJS.NodeJS", "Microsoft.PowerShell", "Python.Python.3.11", "qBittorrent.qBittorrent", "RevoUninstaller.RevoUninstaller", "RustDesk.RustDesk", "Front.scrcpy+", "NickeManarin.ScreenToGif", "Starship.Starship", "Valve.Steam", "Stellarium.Stellarium", "Telegram.TelegramDesktop", "Ubisoft.Connect", "VideoLAN.VLC", "NexusMods.Vortex", "Microsoft.VisualStudioCode", "WinSCP.WinSCP", "WiresharkFoundation.Wireshark", "Zoom.Zoom")
