...
$winget_apps = @("7zip.7zip", "Alacritty.Alacritty", "OrangeDrangon.AndroidMessages.Desktop", "angryziber.AngryIPScanner", "AutoHotkey.AutoHotkey", "BleachBit.BleachBit", "Brave.Brave", "SaeraSoft.CaesiumImageCompressor", "AlexandrSubbotin.Cerebro", "Discord.Discord", "File-New-Project.EarTrumpet", "Elgato.4KCaptureUtility", "Epilogue.EpilogueOperator", "yang991178.fluent-reader", "GIMP.GIMP", "Git.Git", "GitHub.GitHubDesktop", "Google.Drive", "HexChat.HexChat", "Inkscape.Inkscape", "JRSoftware.InnoSetup", "WizardsoftheCoast.MTGALauncher", "GuinpinSoft.MakeMKV", "JeffreyPfau.mGBA", "zyedidia.micro", "Microsoft.DirectX", "Microsoft.VCRedist.2015+.x64", "Microsoft.VCRedist.2015+.x86", "mRemoteNG.mRemoteNG", "OpenJS.NodeJS", "OBSProject.OBSStudio", "Microsoft.PowerShell", "Python.Python.3.11", "RevoUninstaller.RevoUninstaller", "Front.scrcpy+", "NickeManarin.ScreenToGif", "Starship.Starship", "Valve.Steam", "Telegram.TelegramDesktop", "ventoy.Ventoy", "VideoLAN.VLC", "VMware.HorizonClient", "Microsoft.VisualStudioCode", "WinSCP.WinSCP", "WiresharkFoundation.Wireshark", "Zoom.Zoom")
