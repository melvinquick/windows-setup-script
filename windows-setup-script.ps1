...
# App Install Lists
$ps_modules = @("Microsoft.Graph", "PSWindowsUpdate", "PSWordCloud")
$scoop_apps_base = @("main/7zip", "main/git")
$scoop_apps_main = @("java/temurin-jdk", "extras/alacritty", "extras/android-messages", "extras/ipscan", "extras/autohotkey", "extras/bleachbit", "extras/blender", "extras/caesium-image-compressor", "extras/discord", "extras/eartrumpet", "games/epic-games-launcher", "nerd-fonts/FiraCode-NF", "extras/fluent-reader", "extras/gimp", "extras/github", "extras/hexchat", "extras/inkscape", "extras/inno-setup", "extras/kdenlive", "extras/makemkv", "games/mgba", "main/micro", "extras/firefox", "extras/mremoteng", "main/neofetch", "main/nodejs", "scoop install main/nu", "extras/obs-studio", "main/python", "extras/qbittorrent-enhanced", "main/r", "extras/revouninstaller", "extras/rstudio", "main/scrcpy", "extras/screentogif", "main/starship", "versions/steam", "extras/sysinternals", "extras/telegram", "extras/ventoy", "extras/vlc", "extras/vortex", "extras/vscode", "extras/winscp", "extras/wireshark", "extras/zoom")
